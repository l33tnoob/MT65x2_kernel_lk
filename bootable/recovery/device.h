...
class Device {
  public:
    ...
    enum BuiltinAction { NO_ACTION, REBOOT, APPLY_EXT, APPLY_SDCARD2, APPLY_CACHE,
                         APPLY_ADB_SIDELOAD, WIPE_DATA, WIPE_CACHE, USER_DATA_BACKUP, USER_DATA_RESTORE, FORCE_APPLY_SDCARD_SIDELOAD, FORCE_APPLY_SDCARD2_SIDELOAD };
#else
    enum BuiltinAction { NO_ACTION, REBOOT, APPLY_EXT, APPLY_CACHE,
                         APPLY_ADB_SIDELOAD, WIPE_DATA, WIPE_CACHE, USER_DATA_BACKUP, USER_DATA_RESTORE, FORCE_APPLY_SDCARD_SIDELOAD };
