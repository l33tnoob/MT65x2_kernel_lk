...
#define LOG_TAG "MtkCam/entry_mdk"
//
#include <dlfcn.h>
...
Mdk_Open()
{
    ...
    char const szEntrySymbol[] = "MDK_Open";
    //
...
Mdk_Close()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "MDK_Close";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
...
Mdk_Init()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "MDK_Init";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
...
Mdk_DeInit()
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)();
    char const szEntrySymbol[] = "MDK_DeInit";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
 ...
 ******************************************************************************/
MBOOL
Mdk_IOControl(MUINT32 a_u4Ioctl, ACDK_FEATURE_INFO_STRUCT *a_prAcdkFeatureInfo)
{
    //  entry type / entry name
    typedef MBOOL (*pfnEntry_T)(MUINT32, ACDK_FEATURE_INFO_STRUCT*);
    char const szEntrySymbol[] = "MDK_IOControl";
    //
    pfnEntry_T pfnEntry = (pfnEntry_T)::getModuleEntry(szEntrySymbol);
    if  ( ! pfnEntry )
    {
