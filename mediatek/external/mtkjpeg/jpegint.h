...
struct jpeg_entropy_encoder {
  ...
  JMETHOD(void, finish_pass, (j_compress_ptr cinfo));
#if 1//def JPEG_THREAD_SUPPORT
  JMETHOD(boolean, encode_mcu_thread, (j_compress_ptr cinfo, JBLOCKROW *MCU_data, int index));
  JMETHOD(boolean, emit_restart_thread, (j_compress_ptr cinfo, int index, int restart_flag, int restart));
#endif
};
