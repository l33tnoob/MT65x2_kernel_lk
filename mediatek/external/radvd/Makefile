...
ACLOCAL = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run aclocal-1.11
AMTAR = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run autoconf
AUTOHEADER = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run autoheader
AUTOMAKE = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CONDITIONAL_SOURCES = privsep-linux.o device-linux.o netlink.o
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = \
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = radvd
PACKAGE_BUGREPORT = 
...
YACC = bison -y
YFLAGS = 
abs_builddir = /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5
abs_srcdir = /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5
abs_top_builddir = /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5
abs_top_srcdir = /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /proj/mtk80842/lhl/radvd-1.8.5/radvd-1.8.5/install-sh
...
radvd_LDADD = \
	privsep-linux.o device-linux.o netlink.o
