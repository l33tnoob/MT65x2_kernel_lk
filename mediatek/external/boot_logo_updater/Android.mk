...
LOCAL_SHARED_LIBRARIES := libcutils libutils libc libstdc++ libz libdl liblog libshowlogo


$(info COMMON_LOGO_PATH ------$(LOCAL_PATH)/../libshowlogo/)
$(info LIB_SHOW_LOGO_PATH ------$(TOP)/mediatek/external/libshowlogo/)
