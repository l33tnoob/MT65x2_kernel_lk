...
int32_t mmp_vp_init(tracer_handle_t self) {return 0;}
int32_t mmp_vp_begin(tracer_handle_t self, const char *name, uint32_t pid) {return 0;}
int32_t mmp_vp_end(tracer_handle_t self, const char* name, uint32_t pid) {return 0;}
int32_t mmp_vp_oneshot(tracer_handle_t self, uint32_t type, const char *name, uint32_t pid) {return 0;}
