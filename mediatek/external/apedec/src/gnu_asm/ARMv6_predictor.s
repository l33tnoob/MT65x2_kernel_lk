...
@    MEND
    ...
    .global predictor_decode_stereo_asm    
    .type   predictor_decode_stereo_asm,%function              
...
move_hist:
    ...
    b       done
    .size   predictor_decode_stereo_asm, .-predictor_decode_stereo_asm
...
@    EXPORT predictor_decode_mono_asm   
              .global     predictor_decode_mono_asm          
              .type       predictor_decode_mono_asm,%function
...
move_histm:
    ...
    b       donem
    .size   predictor_decode_mono_asm, .-predictor_decode_mono_asm
