...
FRAME test_frames[TEST_FRAMES] = {
    {"/data/prv03.i420",                640,  640,  480, HAL_PIXEL_FORMAT_I420, NATIVE_WINDOW_API_EGL},        
    {"/data/out_176_144.i420",          176,  176,  144, HAL_PIXEL_FORMAT_I420, NATIVE_WINDOW_API_EGL},
    {"/data/school_640x480_1.i420",     640,  640,  480, HAL_PIXEL_FORMAT_I420, NATIVE_WINDOW_API_EGL},
};
char cmd_path[128]={"/data/layer_test"};
...
static void usage(const char* pname)
{
    fprintf(stderr,
            "usage: %s [-g] [FILENAME]\n"
            "   -g: save golden data\n"
            "If FILENAME is not given, the results will be saved to /data/layer_test_gold.bgra.\n",
            pname
    );
}
