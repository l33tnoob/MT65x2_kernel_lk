...
public class ChipsTest extends AndroidTestCase {
    ...
    class BaseMockRecipientEditTextView extends MTKRecipientEditTextView {
        ...
        public BaseMockRecipientEditTextView(Context context) {
            ...
            /// M: Let the control know about we are doing auto testing
            setIsAutoTesting();
        }
        ...
        public void cloneSortedRecipients() {
            mMockRecips = super.getSortedRecipients();        
        }
    ...
    public void testCreateDisplayText() {
        MTKRecipientEditTextView view = createViewForTesting();
    ...
    public void testTooManyRecips() {
        ...
        view.cloneSortedRecipients();
        view.createMoreChip();
        ImageSpan moreChip = view.getMoreChip();
        // We show 2 chips then place a more chip.
        RecipientEntry entry = RecipientEntry.constructFakeEntry(MTKRecipientEditTextView.CHIP_LIMIT + "");        
        String chipText = view.createChipDisplayText(entry);
        int secondStart = view.getText().toString().indexOf(chipText);
        assertEquals(view.getText().getSpanStart(moreChip), secondStart);
        assertEquals(view.getText().getSpanEnd(moreChip), view.length());
        ///M: we have cloned the chips to mMockRecips
