...
protected: 
    ...
    MBOOL     startOne(ImgBufInfo const & rImgBufInfo, ImgBufInfo const & rJpegSImgBufInfo);
    ...
    MBOOL     decodeJpegImg(ImgBufInfo const &rJpegImgBufInfo, MUINT32 fileSize,
                            ImgBufInfo const &rDstImgBufInfo, EImageFormat eImgFmt);
