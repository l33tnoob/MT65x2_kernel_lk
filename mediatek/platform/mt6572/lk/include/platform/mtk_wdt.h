...
/*WDT_REQ_IRQ_EN*/
#define MTK_WDT_REQ_IRQ_EN_KEY		(0x44000000)
#define MTK_WDT_REQ_IRQ_EN_SPM		(0x0001)
#define MTK_WDT_REQ_IRQ_EN_PCM		(0x0002)

/*WDT_DRAMC_CTL*/
#define MTK_WDT_DRAMC_CTL_KEY		(0x59000000)

#define MTK_WDT_MCU_LATCH_ENABLE		(0x0002)
...
extern void mtk_wdt_presrv_mode_config(unsigned int ddr_resrv_en, unsigned int mcu_latch_en);
