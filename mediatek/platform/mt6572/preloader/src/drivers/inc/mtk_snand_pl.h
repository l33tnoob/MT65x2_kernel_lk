...
#ifndef _MTK_SNAND_CORE_H
#define _MTK_SNAND_CORE_H
...
//------ Common Exported APIs ------
extern u32          nand_init_device(void);
extern unsigned int nand_block_bad(unsigned int logical_addr);
extern bool         nand_block_bad_hw(u32 logical_addr);
...
extern int          mtk_nand_erase(u32 logical_addr);
