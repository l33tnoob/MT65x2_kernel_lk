...
#define RET_ERR_UNKNOWN     2            /**< Generic unknown error */

// TODO: define return codes according to Svp trustlet
#define RET_ERR_CONFIG_OVL_LAYER 2
#define RET_ERR_SWITCH_OVL_LAYER 3
