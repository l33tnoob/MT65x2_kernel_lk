...
#ifndef _MTK_CAMERA_INC_CAMPIPE_IXDP_PIPE_H_
#define _MTK_CAMERA_INC_CAMPIPE_IXDP_PIPE_H_
...
/**  
 * @class IXdpPipe
 * @brief Interface of Xdp pipe  
 * @details 
 * The pipe is used for resize pipe \n
 * The data path will be Mem --> XDP(Resizer) --> Mem \n
 *
 */
class IXdpPipe : public IPipe
{
public:
    static EPipeID const ePipeID = ePipeID_1x2_Mem_Xdp_Mem;

public:     ////    Instantiation.
    /**
     * @brief Create the Xdp pipe instance 
     *
     * @details      
     *
     * @note 
     ...
     *
     */   
    static IXdpPipe* createInstance(ESWScenarioID const eScenarioID, EScenarioFmt const eScenarioFmt);
public:
    /**
...
#endif  //  _MTK_CAMERA_INC_CAMPIPE_IXDP_PIPE_H_
