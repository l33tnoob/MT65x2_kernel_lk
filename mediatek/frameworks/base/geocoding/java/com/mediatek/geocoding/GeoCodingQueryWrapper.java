 ...
 */
public class GeoCodingQueryWrapper implements IGeoCodingQuery {
    private static final String LOG_TAG = "GeoCodingQueryWrapper";
    private static Object mInstanceObjectSync = new Object();
    private static GeoCodingQuery myInstance = null;
    private Context mContext = null;
    
    public GeoCodingQueryWrapper(String getInstance, Context context) {
        mContext = context;
    }

    private static GeoCodingQuery getInstance(Context context) {
    ...
    public String queryByNumber(String number) {
        return getInstance(mContext).queryByNumber(number);
    }

}/* End of GeoCodingQueryWrapper class */
