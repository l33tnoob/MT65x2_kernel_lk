...
public class HtmlTest extends TestCase {
    ...
    public void testParagraphs() throws Exception {
        ...
        s = new SpannableString("Hello world\n\n\nor something");
        assertEquals(Html.toHtml(s), "<p dir=\"ltr\">Hello world<br></p>\n<p dir=\"ltr\">or something</p>\n");
    ...
    public void testBlockquote() throws Exception {
        ...
        assertEquals(Html.toHtml(s), "<blockquote><p dir=\"ltr\">Hello world</p>\n</blockquote>\n");

        s = new SpannableString("Hello\n\nworld");
        s.setSpan(new QuoteSpan(), 0, 7, Spannable.SPAN_PARAGRAPH);
        assertEquals(Html.toHtml(s), "<blockquote><p dir=\"ltr\">Hello</p>\n</blockquote>\n<p dir=\"ltr\">world</p>\n");
    }
    ...
    public void testMarkup() throws Exception {
        ...
        assertEquals(Html.toHtml(s),
                     "<p dir=\"ltr\">Hello <a href=\"http://www.google.com\">linky</a> world</p>\n");
    }
