...
public class DatabaseUtilsTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        mLocale = DatabaseUtils.getCollatorLocale();
    }
    ...
    public void testGetCollatorLocale() {

    	//set Locale 
    	String language = "en_";
    	String country="EN";
    	Locale locale = new Locale (language,country);
    	DatabaseUtils.setCollatorLocale(locale);

    	// get Locale 
    	Locale tempLocale = DatabaseUtils.getCollatorLocale();

    	assertTrue(language.equals(tempLocale.getLanguage()));
    	assertTrue(country.equals(tempLocale.getCountry()));

    }

    public void testSetCollatorLocale() {
