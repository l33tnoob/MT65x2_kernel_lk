...
package com.mediatek.common.widget.tests.util;
...
public abstract class ListScenario extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /**
         * M: [ALPS00428138] 1. enable fading edge, otherwise setting fading edge length is unmeaning
         * 2. set small velocity scale to disable fling @{
         */
