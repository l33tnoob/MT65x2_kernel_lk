...
package com.mediatek.common.widget.tests.scroll.arrowscroll;

import com.mediatek.common.widget.tests.scroll.arrowscroll.MultiPageTextWithPadding;
...
public class MultiPageTextWithPaddingTest extends
    ...
    public MultiPageTextWithPaddingTest() {
        super("com.mediatek.common.widget.tests", MultiPageTextWithPadding.class);
    }
    ...
    public void testScrollDownToBottom() throws Exception {
        ...
        int scrollsNeeded = (int)Math.ceil(Math.max(0.0f,
                (mTextView.getHeight() - (mScrollView.getHeight() - mScrollView.getPaddingTop() - mScrollView
                        .getPaddingBottom())))
                / mScrollView.getMaxScrollAmount());
        /// @}        
