...
package com.mediatek.common.widget.tests.layout.linear;

import com.mediatek.common.widget.tests.layout.linear.BaselineAlignmentZeroWidthAndWeight;
import com.mediatek.common.widget.tests.layout.linear.ExceptionTextView;
...
public class BaselineAlignmentZeroWidthAndWeightTest extends ActivityInstrumentationTestCase<BaselineAlignmentZeroWidthAndWeight> {
    ...
    public BaselineAlignmentZeroWidthAndWeightTest() {
        super("com.mediatek.common.widget.tests", BaselineAlignmentZeroWidthAndWeight.class);
    }
