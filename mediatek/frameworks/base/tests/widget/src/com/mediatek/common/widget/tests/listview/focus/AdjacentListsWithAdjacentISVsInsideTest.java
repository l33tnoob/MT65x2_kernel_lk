...
import com.mediatek.common.widget.tests.listview.AdjacentListsWithAdjacentISVsInside;
import com.mediatek.common.widget.tests.util.InternalSelectionView;
...
public class AdjacentListsWithAdjacentISVsInsideTest extends ActivityInstrumentationTestCase<AdjacentListsWithAdjacentISVsInside> {
    ...
    public AdjacentListsWithAdjacentISVsInsideTest() {
        super("com.mediatek.common.widget.tests", AdjacentListsWithAdjacentISVsInside.class);
    }
    ...
    public void testFocusTransfersOutsideOfListWhenNoCandidateInsideHorizontal() {
        ...
        assertEquals("mRightMiddleIsv.getSelectedRow()", 0, mRightMiddleIsv.getSelectedRow());
