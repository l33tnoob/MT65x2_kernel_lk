...
package com.mediatek.common.widget.tests.touchmode;

import com.mediatek.common.widget.tests.layout.linear.LLOfButtons1;
import com.mediatek.common.widget.tests.layout.linear.LLOfButtons2;
import static com.mediatek.common.widget.tests.util.TouchModeFlexibleAsserts.assertInTouchModeAfterClick;
import static com.mediatek.common.widget.tests.util.TouchModeFlexibleAsserts.assertNotInTouchModeAfterKey;
import static com.mediatek.common.widget.tests.util.TouchModeFlexibleAsserts.assertInTouchModeAfterTap;
...
public class ChangeTouchModeTest extends ActivityInstrumentationTestCase<LLOfButtons1> {
    ...
    public ChangeTouchModeTest() {
        super("com.mediatek.common.widget.tests", LLOfButtons1.class);
    }
    ...
    public void testTouchModeFalseAcrossActivites() throws Exception {
        ...
        try {
            otherActivity =
                    launchActivity("com.mediatek.common.widget.tests", LLOfButtons2.class, null);
