...
@SuppressLint("NewApi")
@TargetApi(15)
public class ScaleGestureDetectorTest extends ActivityInstrumentationTestCase2<ScaleGestureDetectorActivity> {
	private ScaleGestureDetectorActivity mActivity;
	
	private ActionBarUtils mActionBarUtils;

	public ScaleGestureDetectorTest() {
		super("com.example.actionbaractivity", ScaleGestureDetectorActivity.class);
	}
	...
	protected void setUp() throws Exception {
		...
		mActivity = (ScaleGestureDetectorActivity)getActivity();
