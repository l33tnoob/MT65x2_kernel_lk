...
import com.mediatek.common.widget.tests.layout.linear.LLOfTwoFocusableInTouchMode;
...
public class FocusableInTouchModeClickTest extends ActivityInstrumentationTestCase2<LLOfTwoFocusableInTouchMode> {
    ...
    public FocusableInTouchModeClickTest() {
        super("com.mediatek.common.widget.tests", LLOfTwoFocusableInTouchMode.class);
    }
