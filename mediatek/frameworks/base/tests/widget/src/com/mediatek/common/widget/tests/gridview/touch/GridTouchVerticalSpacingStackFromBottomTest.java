...
import com.mediatek.common.widget.tests.gridview.GridVerticalSpacingStackFromBottom;
...
public class GridTouchVerticalSpacingStackFromBottomTest extends ActivityInstrumentationTestCase<GridVerticalSpacingStackFromBottom> {
    ...
    public GridTouchVerticalSpacingStackFromBottomTest() {
        super("com.mediatek.common.widget.tests", GridVerticalSpacingStackFromBottom.class);
    }
    ...
    public void testShortScroll() {
        ...
        assertEquals("View scrolled to wrong position", lastTop, newLastChild.getTop() - 1 - 10);
        /// @}
    ...
    public void testLongScroll() {
        ...
        assertEquals("View scrolled to wrong position", firstTop
                + (distance - mViewConfig.getScaledTouchSlop()), firstChild.getTop());
        /// @}
    } 
