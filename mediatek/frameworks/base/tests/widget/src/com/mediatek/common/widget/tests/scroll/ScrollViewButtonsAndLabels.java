...
/// M: [ALPS00428138] get ViewConfirguration for friction
...
public class ScrollViewButtonsAndLabels extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        /// M: [ALPS00428138] test more functions @{
        mScrollView.setVerticalFadingEdgeEnabled(true);
        mScrollView.setFadingEdgeLength(screenHeight/15);
        mScrollView.setFriction(ViewConfiguration.getScrollFriction());
        /// @}
    }
