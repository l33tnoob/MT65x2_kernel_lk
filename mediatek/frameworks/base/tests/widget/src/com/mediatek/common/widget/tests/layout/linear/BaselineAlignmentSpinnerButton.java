...
import com.mediatek.common.widget.tests.layout.linear.HorizontalOrientationVerticalAlignment;
...
public class BaselineAlignmentSpinnerButton extends ActivityInstrumentationTestCase<HorizontalOrientationVerticalAlignment> {
    ...
    public BaselineAlignmentSpinnerButton() {
        super("com.mediatek.common.widget.tests", HorizontalOrientationVerticalAlignment.class);
    }
