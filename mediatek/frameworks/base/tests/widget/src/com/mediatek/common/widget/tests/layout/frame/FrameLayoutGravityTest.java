...
package com.mediatek.common.widget.tests.layout.frame;
...
import com.mediatek.common.widget.tests.layout.frame.FrameLayoutGravity;
...
public class FrameLayoutGravityTest extends ActivityInstrumentationTestCase<FrameLayoutGravity> {
    ...
    public FrameLayoutGravityTest() {
        super("com.mediatek.common.widget.tests", FrameLayoutGravity.class);
    }
