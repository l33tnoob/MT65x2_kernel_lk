...
import com.mediatek.common.view.tests.menu.MenuWith1Item;
import com.mediatek.common.view.tests.util.KeyUtils;
...
public class MenuWith1ItemTest extends ActivityInstrumentationTestCase<MenuWith1Item> {
    ...
    public MenuWith1ItemTest() {
        super("com.mediatek.common.view.tests", MenuWith1Item.class);
    }
