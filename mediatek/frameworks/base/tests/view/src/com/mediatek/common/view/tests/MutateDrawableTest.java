...
import com.mediatek.common.view.tests.MutateDrawable;
...
public class MutateDrawableTest extends ActivityInstrumentationTestCase2<MutateDrawable> {
    ...
    public MutateDrawableTest() {
        super("com.mediatek.common.view.tests", MutateDrawable.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mFirstButton = getActivity().findViewById(com.mediatek.common.view.tests.R.id.a);
        mSecondButton = getActivity().findViewById(com.mediatek.common.view.tests.R.id.b);
    }
