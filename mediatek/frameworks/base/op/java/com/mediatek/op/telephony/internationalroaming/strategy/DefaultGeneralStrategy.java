...
public class DefaultGeneralStrategy extends StrategyBase implements IGeneralStrategy {
    private static final String TAG = "[DefaultGeneralStrategy]";

    public DefaultGeneralStrategy(IInternationalRoamingController controller, Context context,
    ...
    public void onDualPhoneRadioAvailable() {
        logd("onDualPhoneRadioAvailable...");
    }

    @Override
    public void onDualPhoneRadioOn(int reason) {
        logd("onDualPhoneRadioOn: reason = " + reason);
    }
