...
public class PictureQuality {
    ...
    public static final int MTK_PQ_MODE_NORMAL = 0x000000;
    public static final int MTK_PQ_MODE_CAMERA = 0x000001;
    public static final int MTK_PQ_MODE_MASK   = 0x000001;
    ...
    {
        if((mode & PictureQuality.MTK_PQ_MODE_MASK) == PictureQuality.MTK_PQ_MODE_CAMERA)
        {
