...
jint getIntField(JNIEnv* env, jclass convergenceClass, jobject convergence, const char* fieldName);
void setIntField(JNIEnv* env, jclass convergenceClass, jobject convergence, const char* fieldName, int value);
void setArrayField(JNIEnv* env, jclass convergenceClass, jobject convergence, const char* fieldName, int* inputArr);
