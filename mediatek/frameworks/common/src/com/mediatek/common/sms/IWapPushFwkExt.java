...
public interface IWapPushFwkExt {
    /*
     * identifier for Auto-Push notification
     */
    public static final int AUTO_PUSH_NOTI_ID = 4999;

    /*
     * action for canceling Auto-Push notification
     */
    public static final String ACTION_WAP_PUSH_NOTI_CANCEL = "com.mediatek.cu_wap_push_permission_cancel";

    /*
     * Check WAP Push setting to decide whether dispatch the push message to
     * apps
     * @return true should dispatch push message out, false should not
     */
    public boolean allowDispatchWapPush();

    /*
     * check whether the push message is for MMS
     */
