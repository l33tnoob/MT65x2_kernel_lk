...
public class ImmutablePoint extends Point {
     ...
     */
    public ImmutablePoint(float x, float y, float z) {
        super(x, y, z);
    }
    ...
    public final void set(float x, float y, float z) {
        throw new Ngin3dException("Not allow to modify immutable Point with set("
                + x + ", " + y + ", " + z + "), "
                + "it might be a default Point. Create new Point() first then use that");
    }
