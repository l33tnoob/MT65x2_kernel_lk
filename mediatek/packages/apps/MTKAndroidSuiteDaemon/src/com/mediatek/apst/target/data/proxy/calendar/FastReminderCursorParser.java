...
public class FastReminderCursorParser extends FastCursorParser {
    /**
     * @param cursor
     *            The cursor of the reminder.
     * @param consumer
     *            Set a consumer to handle the asynchronous blocks.
     * @param buffer
     *            The buffer to save the reminder.
     */
    public FastReminderCursorParser(Cursor cursor, IRawBlockConsumer consumer,
            ByteBuffer buffer) {
    ...
    public int onParseCursorToRaw(Cursor cursor, ByteBuffer buffer) {
        return ReminderContent.cursorToRaw(cursor, buffer);
    }
