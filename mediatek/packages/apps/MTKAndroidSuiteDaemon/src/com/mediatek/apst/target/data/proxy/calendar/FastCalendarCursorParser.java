...
public class FastCalendarCursorParser extends FastCursorParser {
    /**
     * @param cursor
     *            The cursor of the calendar.
     * @param consumer
     *            Set a consumer to handle the asynchronous blocks.
     * @param buffer
     *            The buffer to save the calendar.
     */
    public FastCalendarCursorParser(Cursor cursor, IRawBlockConsumer consumer,
            ByteBuffer buffer) {
    ...
    public int onParseCursorToRaw(Cursor c, ByteBuffer buffer) {
        return CalendarContent.cursorToRaw(c, buffer);
    }
}
