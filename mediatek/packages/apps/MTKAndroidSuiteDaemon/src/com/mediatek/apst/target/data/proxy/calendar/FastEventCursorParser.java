...
public class FastEventCursorParser extends FastCursorParser {
    /**
     * @param cursor
     ...
     */
    public FastEventCursorParser(Cursor cursor, IRawBlockConsumer consumer,
            ByteBuffer buffer) {
    ...
    public int onParseCursorToRaw(Cursor cursor, ByteBuffer buffer) {
        return CalendarEventContent.cursorToRaw(cursor, buffer);
    }
}
