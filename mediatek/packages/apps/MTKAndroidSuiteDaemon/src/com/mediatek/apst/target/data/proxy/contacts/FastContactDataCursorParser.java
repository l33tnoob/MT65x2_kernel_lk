...
public class FastContactDataCursorParser extends FastCursorParser {
    /**
     * Data cursor should be ordered by rawContactId, _id (in ascend order) to
     * guarantee that blocks were generated rightly.
     * 
     * @param cursor
     *            The cursor to parse.
     * @param consumer
     ...
     */
    public FastContactDataCursorParser(Cursor cursor,
     ...
     *            Set a consumer to handle the asynchronous blocks.
     */
    public FastContactDataCursorParser(Cursor cursor, IRawBlockConsumer consumer) {
    ...
    public int onParseCursorToRaw(Cursor c, ByteBuffer buffer) {
        return ContactDataContent.cursorToRaw(c, buffer);
    }
}
