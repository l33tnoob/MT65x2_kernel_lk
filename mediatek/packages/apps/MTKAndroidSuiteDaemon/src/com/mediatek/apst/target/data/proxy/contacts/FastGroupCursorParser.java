...
public class FastGroupCursorParser extends FastCursorParser {
    /**
     * @param cursor
     *            The cursor of the group.
     * @param consumer
     *            Set a consumer to handle the asynchronous blocks.
     * @param buffer
     *            The buffer to save the group.
     */
    public FastGroupCursorParser(Cursor cursor, IRawBlockConsumer consumer,
            ByteBuffer buffer) {
    ...
    public int onParseCursorToRaw(Cursor c, ByteBuffer buffer) {
        return GroupContent.cursorToRaw(c, buffer);
    }
}
