...
public class FastRawContactsCursorParser extends FastCursorParser {

    /**
     * @param cursor
     *            The cursor of the raw contact.
     * @param consumer
     *            Set a consumer to handle the asynchronous blocks.
     * @param buffer
     *            The buffer to save the raw contact.
     */
    public FastRawContactsCursorParser(Cursor cursor,
     ...
     *            Set a consumer to handle the asynchronous blocks.
     */
    public FastRawContactsCursorParser(Cursor cursor, IRawBlockConsumer consumer) {
    ...
    public int onParseCursorToRaw(Cursor c, ByteBuffer buffer) {
        return RawContactsContent.cursorToRaw(c, buffer);
    }
}
