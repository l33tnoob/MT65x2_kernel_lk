...
public class GetAllContsDataForBackupReqTest extends AndroidTestCase {
    private GetAllContsDataForBackupReq mGetAllContsDataForBackupReq;
    ...
    public void test01_getRequestingDataTypes() {
