...
public class GetAllBookmarkForBackupRspTest extends AndroidTestCase {
    private GetAllBookmarkForBackupRsp mGetAllBookmarkForBackupRsp;

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        mGetAllBookmarkForBackupRsp = new GetAllBookmarkForBackupRsp(32);
    }
    ...
    public void test01_getmBookmarkDataList() {
    ...
    public void test02_getmBookmarkFolderList() {
    ...
    public void test03_getGetAllBookmarkInfoResults() {
        mGetAllBookmarkForBackupRsp
                .setGetAllBookmarkInfoResults("bookmark result");
        assertEquals("bookmark", mGetAllBookmarkForBackupRsp
                .getGetAllBookmarkInfoResults());
    }
}
