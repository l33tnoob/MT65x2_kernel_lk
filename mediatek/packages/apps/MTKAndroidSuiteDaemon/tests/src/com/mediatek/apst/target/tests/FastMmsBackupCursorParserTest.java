...
import com.mediatek.apst.target.data.proxy.message.FastMmsBackupCursorParser;
...
public class FastMmsBackupCursorParserTest extends AndroidTestCase {

    private MessageProxy mMessageProxy;

    private FastMmsBackupCursorParser mCursorParser;
    ...
    public void test01_OnParseCursorToRaw() {
        ...
        Cursor cursor = mMessageProxy.getContentResolver().query(MmsContent.CONTENT_URI, null, null, null,
                MmsContent.COLUMN_DATE);
        assertTrue(cursor.moveToNext());
        mCursorParser = new FastMmsBackupCursorParser(cursor, mConsumer, mBuffer, mMessageProxy);
