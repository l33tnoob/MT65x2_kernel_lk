...
import com.mediatek.apst.util.command.RawBlockRequest.Builder;

public class RawBlockRequestTest extends AndroidTestCase {
    private RawBlockRequest mRawRequest;

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        mRawRequest = new RawBlockRequest(BaseCommand.FEATURE_CONTACTS);
    ...
    public void test01_getRaw() {
        mRawRequest.setRaw(null);
        byte[] raw = mRawRequest.getRaw();
    ...
    public void test02_getRaw() {
        ...
        mRawRequest.setRaw(raw1);
        byte[] raw2 = mRawRequest.getRaw();
    ...
    public void test03_builder() {
        Builder builder = RawBlockRequest.builder(BaseCommand.FEATURE_CONTACTS);
    ...
    public void test04_builder() {
        Builder builder = RawBlockRequest.builder(10,
    ...
    public void test05_builder() {
        Builder builder = RawBlockRequest.builder(-1,
                BaseCommand.FEATURE_CONTACTS);
        assertNotNull(builder);
    }
}
