...
public class RCSePhonePlugin extends InCallUIPluginDefault{
    ...
    public CallButtonExtension getCallButtonExtension() {
        log("getCallButtonExtension RCSe");
        return new RCSeCallButtonExtension(mPluginContext,this);
    }

    public InCallUIExtension getInCallUIExtension() {
        log("getInCallUIExtension RCS-e");
        return RCSeInCallUIExtension.getInstance();
    }


    public CallCardExtension getCallCardExtension() {
        log("getCallCardExtension RCSe");
