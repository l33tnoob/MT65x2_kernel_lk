...
public class AsyncAvatarView extends QuickContactBadge {
    ...
    public AsyncAvatarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        PhotoLoaderManager.initialize(context);
    }

    public AsyncAvatarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setAsyncContact(TreeSet<String> numbers) {
        ...
        if (numbers != null) {
            mAvatarViewWorker.setAsyncContact(numbers);
        }
    }
