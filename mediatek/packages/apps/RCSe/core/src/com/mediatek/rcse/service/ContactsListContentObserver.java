...
public class ContactsListContentObserver extends ContentObserver
{
   ...
   public ContactsListContentObserver(Handler handler, Context context)
   {
       super(handler);
       mContext = context;
       Logger.d(TAG, "ContactsListContentObserver constructor called with handler " );
   } 

   @Override 
   public void onChange(boolean selfChange)
   {  
       Logger.d(TAG, "ContactsListContentObserver onChange called " );
   ...
   public void onChange(boolean selfChange, Uri uri) {
       // Handle change.
       Logger.d(TAG, "ContactsListContentObserver onChange called with uri " );
