...
/**
 * Only apn access network
 */
public class OnlyApnNetworkAccess extends NetworkAccess {
     ...
     */
    public OnlyApnNetworkAccess() throws CoreException {
        super();

        if (logger.isActivated()) {
            logger.info("OnlyApn access has been created (interface " + getNetworkName() + ")");
        }
    }
