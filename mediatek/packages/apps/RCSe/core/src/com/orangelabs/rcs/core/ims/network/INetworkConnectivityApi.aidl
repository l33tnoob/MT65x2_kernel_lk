...
interface INetworkConnectivityApi {
    //Add network connectivity listener.
    void addNetworkConnectivityListener(in INetworkConnectivity listener);

    //Remove network connectivity listener.
    void removeNetworkConnectivityListener(in INetworkConnectivity listener);
}
