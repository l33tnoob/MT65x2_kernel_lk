...
public class MessagingApi extends ClientApi {
	...
	public IChatSession initiateAdhocGroupChatSession(List<String> participants) throws ClientApiException {
		return initiateAdhocGroupChatSession(participants, null,null);
	}
	 ...
	 * @throws ClientApiException
	 */
	public IChatSession initiateAdhocGroupChatSession(List<String> participants, String subject , String firstMessage) throws ClientApiException {
    	if (coreApi != null) {
			try {
		    	return coreApi.initiateAdhocGroupChatSession(participants, subject,firstMessage);
			} catch(Exception e) {
				throw new ClientApiException(e.getMessage());
			}
		} else {
