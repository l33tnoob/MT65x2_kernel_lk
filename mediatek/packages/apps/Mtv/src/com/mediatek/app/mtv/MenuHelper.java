...
public class MenuHelper {
    ...
    /**
     * Go to Gallery Activity, start to watch the image and video of ATV.
     * @param activity MenuHelper use the activity start Gallery activity.
     */
    ...
    private static void gotoGallery(Activity activity, int windowTitleId,
        ...
        try {
            ...
            XLogUtils.e(TAG, "Could not start gallery activity", e);
        }
    }    
}
