...
public class GravityMenuActivity extends ListActivity {	
	   ...
	   */
	   ...
	   public void onCreate(Bundle savedInstanceState) {
		  ...
		  // mItemRes[ITEM_BROWSE] = R.string.browse;
		   ...
		   mAdapter = new ArrayAdapter<String>(GravityMenuActivity.this, R.layout.game_item, mString);
		   GravityMenuActivity.this.setListAdapter(mAdapter);
	   } 
	   ...
	   protected void onListItemClick(ListView list, View view, int position, long id)
	   {
		   if (id == ITEM_OUTPUT) {
			   ...
			   intent.setClass(GravityMenuActivity.this, GravityRawActivity.class);
