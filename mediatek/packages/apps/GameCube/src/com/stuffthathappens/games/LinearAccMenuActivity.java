...
public class LinearAccMenuActivity extends ListActivity {	
	   ...
	   */
	   ...
	   public void onCreate(Bundle savedInstanceState) {
		  ...
		  // mItemRes[ITEM_BROWSE] = R.string.browse;
		   ...
		   mAdapter = new ArrayAdapter<String>(LinearAccMenuActivity.this, R.layout.game_item, mString);
		   LinearAccMenuActivity.this.setListAdapter(mAdapter);
	   } 
	   ...
	   protected void onListItemClick(ListView list, View view, int position, long id)
	   {
		   if (id == ITEM_OUTPUT) {
			   ...
			   intent.setClass(LinearAccMenuActivity.this, LinearAccRawActivity.class);
