...
public class PressMenuActivity extends ListActivity {	
	   ...
	   */
	   ...
	   public void onCreate(Bundle savedInstanceState) {
		  ...
		  // mItemRes[ITEM_BROWSE] = R.string.browse;
		   ...
		   mAdapter = new ArrayAdapter<String>(PressMenuActivity.this, R.layout.game_item, mString);
		   PressMenuActivity.this.setListAdapter(mAdapter);
	   } 
	   ...
	   protected void onListItemClick(ListView list, View view, int position, long id)
	   {
		   if (id == ITEM_OUTPUT) {
			   ...
			   intent.setClass(PressMenuActivity.this, PressRawActivity.class);
