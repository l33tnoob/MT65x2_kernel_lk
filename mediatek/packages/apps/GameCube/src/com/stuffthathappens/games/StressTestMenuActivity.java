...
public class StressTestMenuActivity extends ListActivity {	
   
   private String[] mString;
	   private ArrayAdapter<String> mAdapter;
	   private static int ITEM_STRESS_RANDOM = 0;
	   /*
	   ...
	   */
	   ...
	   public void onCreate(Bundle savedInstanceState) {
		   ...
		   mItemRes = new int[7];
		   mItemRes[ITEM_STRESS_RANDOM] = R.string.stress_random;
		  ...
		  // mItemRes[ITEM_BROWSE] = R.string.browse;
		   ...
		   mString = new String[]
					{
					   getResources().getString(mItemRes[ITEM_STRESS_RANDOM]),
		   ...
		   mAdapter = new ArrayAdapter<String>(StressTestMenuActivity.this, R.layout.game_item, mString);
		   StressTestMenuActivity.this.setListAdapter(mAdapter);
	   } 
	   
	   protected void onListItemClick(ListView list, View view, int position, long id)
	   {
		   if (id == ITEM_STRESS_RANDOM) {
			   Intent intent = new Intent();
			   intent.setClass(StressTestMenuActivity.this, StressTestActivity.class);
