...
public class GyroMenuActivity extends ListActivity {	
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // mItemRes[ITEM_CURVE_ANGLE] = R.string.curve_angle;
        ...
        mAdapter = new ArrayAdapter<String>(GyroMenuActivity.this, R.layout.game_item, mString);
        GyroMenuActivity.this.setListAdapter(mAdapter);
    } 
    ...
    protected void onListItemClick(ListView list, View view, int position, long id)
    {
    	if (id == ITEM_OUTPUT) {
            ...
            intent.setClass(GyroMenuActivity.this, GyroRawActivity.class);
