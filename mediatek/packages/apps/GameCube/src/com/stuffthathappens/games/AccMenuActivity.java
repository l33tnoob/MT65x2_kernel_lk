...
public class AccMenuActivity extends ListActivity {	
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArrayAdapter<String>(AccMenuActivity.this, R.layout.game_item, mString);
        AccMenuActivity.this.setListAdapter(mAdapter);
    } 
    ...
    protected void onListItemClick(ListView list, View view, int position, long id)
    {
    	if (id == ITEM_OUTPUT) {
            ...
            intent.setClass(AccMenuActivity.this, AccRawActivity.class);
            startActivity(intent);    		
    	} else if (id == ITEM_BOUNCING_BALL) {
            Intent intent = new Intent();
            intent.setClass(AccMenuActivity.this, BouncingBallActivity.class);
            startActivity(intent);    		
    	} else if (id == ITEM_ORIENTATION) {
            Intent intent = new Intent();
            intent.setClass(AccMenuActivity.this, OrientationActivity.class);
            startActivity(intent);    		  	    		
    	} else if (id == ITEM_BROWSE) {
            Intent intent = new Intent();
            intent.setClass(AccMenuActivity.this, BrowseActivity.class);
            startActivity(intent);    		  	    		    		
    	} else if (id == ITEM_CURVE_CHART) {
            Intent intent = new Intent();
            intent.setClass(AccMenuActivity.this, CurveActivity.class);
            startActivity(intent);    		  	    		    		    		
    	} else if (id == ITEM_CURVE_ANGLE) {
            Intent intent = new Intent();
            intent.setClass(AccMenuActivity.this, AccCurveAngleActivity.class);
            startActivity(intent);    		  	    		    		    		    	
    	}    	
