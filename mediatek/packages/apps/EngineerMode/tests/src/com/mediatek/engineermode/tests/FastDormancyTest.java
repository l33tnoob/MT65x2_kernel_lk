...
public class FastDormancyTest extends
        ActivityInstrumentationTestCase2<FastDormancy> {
    private Solo mSolo;
    private Context mContext;
    private Instrumentation mIns;
    private Activity mActivity;

    public FastDormancyTest() {
        super("com.mediatek.engineermode", FastDormancy.class);
    }
    ...
    public void testCase01_FastDormancyActivity() {
        verifyPreconditions();
    }

    public void testCase02_TurnOnFD() {
    ...
    public void testCase03_TurnOffFD() {
