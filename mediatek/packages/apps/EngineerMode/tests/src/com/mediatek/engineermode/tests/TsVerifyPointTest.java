...
public class TsVerifyPointTest extends ActivityInstrumentationTestCase2<TsVerifyShakingPoint> {
    private static final String TAG = "TsVerifyPointTest";
    ...
    public void test02_TouchTest() {
        ...
        mSolo.assertCurrentActivity("Not TsVerifyPoint Class", TsVerifyShakingPoint.class);
