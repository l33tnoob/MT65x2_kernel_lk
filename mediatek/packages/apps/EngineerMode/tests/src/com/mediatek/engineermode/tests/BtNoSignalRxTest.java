...
public class BtNoSignalRxTest extends
        ActivityInstrumentationTestCase2<NoSigRxTestActivity> {
...
//    private ContentResolver mCr = null;
 //   private ListView mListView = null;
    ...
    public BtNoSignalRxTest() {
        super(NoSigRxTestActivity.class);
    }
...
//            return;
 ...
 //       mListView = (ListView) mActivity.findViewById(R.id.ListView_BtList);
    ...
    public void test02_ChipInfo() {
        ...
        mSolo.assertCurrentActivity("Not NoSigRxTestActivity Class", NoSigRxTestActivity.class);
        ...
        mSolo.clickOnButton(testActivity.getString(R.string.OK));
        mSolo.sleep(EmOperate.TIME_SUPER_LONG);
