...
public class ChargeBatteryTest extends ActivityInstrumentationTestCase2<ChargeBattery> {
    ...
    public ChargeBatteryTest() {
        super("com.mediatek.engineermode", ChargeBattery.class);
    }
