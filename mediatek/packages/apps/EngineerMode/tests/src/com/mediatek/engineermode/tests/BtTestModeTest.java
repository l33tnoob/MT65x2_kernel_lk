...
public class BtTestModeTest extends ActivityInstrumentationTestCase2<TestModeActivity> {
    ...
    public BtTestModeTest() {
        super(TestModeActivity.class);
    }
    ...
    public void test02_SetTest() {
        ...
        mSolo.assertCurrentActivity("Not TestModeActivity Class", TestModeActivity.class);
