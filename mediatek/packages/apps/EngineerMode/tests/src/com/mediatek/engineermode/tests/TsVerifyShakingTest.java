...
public class TsVerifyShakingTest extends ActivityInstrumentationTestCase2<TsVerifyShakingPoint> {
    private static final String TAG = "TsVerifyShakingTest";
    ...
    public TsVerifyShakingTest() {
        super(TsVerifyShakingPoint.class);
    }
    ...
    public void test02_TouchTest() {
        ...
        mSolo.assertCurrentActivity("Not TsVerifyShaking Class", TsVerifyShakingPoint.class);
