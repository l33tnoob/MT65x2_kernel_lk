...
/*
    public void test02_ItemUsbIf() {
        mSolo.clickOnText(mActivity.getString(R.string.USB_IF_TEST));
        mSolo.waitForActivity(UsbIf.class.getSimpleName(),
                EmOperate.TIME_SUPER_LONG);
        EmOperate.waitSomeTime(EmOperate.TIME_SUPER_LONG);
        EmOperate.backKey(mInst);
    }
    public void test02_ItemUsbEx() {
        mSolo.clickOnText(mActivity.getString(R.string.USB_EX_TEST));
        mSolo.waitForActivity(UsbEx.class.getSimpleName(),
                EmOperate.TIME_SUPER_LONG);
        EmOperate.waitSomeTime(EmOperate.TIME_SUPER_LONG);
        EmOperate.backKey(mInst);
    }
