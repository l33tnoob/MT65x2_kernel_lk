...
public class BtBleTest extends
        ActivityInstrumentationTestCase2<BleTestMode> {
...
//    private ContentResolver mCr = null;
 ...
 //       mListView = (ListView) mActivity.findViewById(R.id.ListView_BtList);
    ...
    public void test02_ChipInfo() {
        ...
        mSolo.assertCurrentActivity("Not BleTestMode Class", BleTestMode.class);
