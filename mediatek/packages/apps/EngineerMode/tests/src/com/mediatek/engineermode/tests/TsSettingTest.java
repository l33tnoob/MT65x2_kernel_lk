...
public class TsSettingTest extends ActivityInstrumentationTestCase2<TouchScreenSettings> {
    private static final String TAG = "TouchScreenSettings";
    ...
    public TsSettingTest() {
        super(TouchScreenSettings.class);
    }
    ...
    public void test02_SetTest() {
        ...
        mSolo.assertCurrentActivity("Not TouchScreenSettings Class", TouchScreenSettings.class);
