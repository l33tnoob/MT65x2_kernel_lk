...
public class WifiStateListener extends Service {

    private static final String TAG = "EM/WiFi_wifiStateListener";
    ...
    private final BroadcastReceiver mWifiStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Xlog.d(TAG, "Wifi state:" + currentState);
            if (EMWifi.sIsInitialed
                    && currentState != WifiManager.WIFI_STATE_ENABLED
