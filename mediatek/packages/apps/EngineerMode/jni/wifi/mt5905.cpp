...
/*
** $Id: mt5905.cpp,v 1.4 2008/10/28 13:45:43 MTK01725 Exp $
*/
...
**
** Revision 1.5  2008/02/23 16:29:32  MTK01385
...
**
** Revision 1.2  2008/01/03 07:52:07  MTK01385
** 1. Add Set Chip type function.
**
** Revision 1.1.1.1  2007/12/10 07:23:01  MTK01385
** WPDWiFiTool for MT5921
**
** Revision 1.4  2007/11/12 06:25:03  MTK01267
** move readMCR32, writeMCR32, readBBCR8, writeBBCR8,
** readEEPRom16, writeEEPRom16 to each chip folder.
**
** Revision 1.3  2007/11/09 03:57:26  MTK01267
** refine code
**
** Revision 1.2  2007/10/17 09:21:33  MTK01267
** let setDACOffsetToEEProm, getDACOffset do nothing
**
...
INT_32
CMT5905::readMCR32 (UINT_32 offset, UINT_32 * value)
{
	IPC_MCR_RW_STRUC m_sMACREG_RW;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT5905::readMCR32");
	INITLOG((_T("\n")));
...
**__________________________________________________________________________*/
INT_32
CMT5905::writeMCR32 (UINT_32 offset, UINT_32 value)
{
	IPC_MCR_RW_STRUC m_sMACREG_RW;

	DEBUGFUNC("CMT5905::writeMCR32");
	INITLOG((_T("\n")));
...
**__________________________________________________________________________*/
INT_32
CMT5905::readBBCR8 (UINT_32 offset, UINT_32* value)
{
...
**__________________________________________________________________________*/
INT_32
CMT5905::writeBBCR8 (UINT_32 offset, UINT_32 value)
{
	IPC_BBCR_RW_STRUC m_sMMI_RW;
...
**__________________________________________________________________________*/
INT_32
CMT5905::readEEPRom16 (UINT_32 offset, UINT_32 * value)
{
...
**__________________________________________________________________________*/
INT_32
CMT5905::writeEEPRom16 (UINT_32 offset, UINT_32 value)
{
	IPC_EEPROM_RW_STRUC m_sEEPRom_RW;
...
CMT5905::setTestMode(void)
{
	...
	if ( !m_OID->setOID(this,
			...
			(CHAR *) &info,
			info.Length)) {
		ERRORLOG("Failed to set driver to test mode\n");
		return ERROR_RFTEST_NDIS_OID_FAILURE;
	}
...
CMT5905::setStandBy(void)
{
	...
	if (m_bEnableContiPktTx == TRUE) {
		...
		if ( !m_OID->setOID(this,
			...
			ERRORLOG("Failed to set stop pattern");
			return ERROR_RFTEST_NDIS_OID_FAILURE;
		}
...
**__________________________________________________________________________*/
INT_32
CMT5905::setLocalFrequecy(INT_32 txPower, INT_32 txAntenna)
{
	UINT_32 status;
...
**__________________________________________________________________________*/
INT_32
CMT5905::setAlcSlopeRatioToEeprom (
...
**__________________________________________________________________________*/
INT_32
CMT5905::setTXMaxPowerToEEProm(INT_32 channelFreg, INT_32 bCck, INT_32 nTxPwr)
{
...
**__________________________________________________________________________*/
INT_32
CMT5905::setTXMaxPowerToEEPromEx(
	INT_32 channelFreq,
	INT_32 rate,
	INT_32 gainControl,
	INT_32 outputPower,
...
**__________________________________________________________________________*/
INT_32
CMT5905::readTxPowerFromEEPromEx(
    INT_32 channelFreq,
    INT_32 rate,
    INT_32 *nTxPwr,
    INT_32 *outputPower,
...
{
	DEBUGFUNC("CMT5905::setPacketRx");
    INITLOG((_T("\n")));

	UINT_32 txmode, tmpAnt = nAntenna;

	txmode = (tmpAnt << 16) | (0xFFFF & condition);
...
INT_32
CMT5905::setEEPromCKSUpdated (void)
{
	UINT_8 checkSum;
...
**__________________________________________________________________________*/
INT_32
CMT5905::findMaxPowerByteOffset(INT_32 nChannel, INT_32 bCck, INT_32 b24Gs)
{
    INT_32 offset;
    INT_32 i;
...
INT_32
CMT5905::setBBTxPower(INT_32 txPower)
{
    /* OFDM TX Power */
...
INT_32
CMT5905::setTxAnt(INT_32 antenna)
{
    UINT_32 nCr8;
...
UINT_8
CMT5905::getTxRate(INT_32 nTxRate, INT_32 nPreamble)
{
	UCHAR ucTxRate = 0;
	switch (nTxRate) {
	    default:
...
UINT_8
CMT5905::nicCalculateChecksumByte(void * startingAddr_p,UINT_32 length)
{
    UINT_32 i;
    UINT_8 * cp;
    UINT_8 result;
...
**__________________________________________________________________________*/
INT_32
CMT5905::getEEPRomVersion_(void)
{
    UINT_32 value;
    UINT_32 eepValue;
...
**__________________________________________________________________________*/
INT_32
CMT5905::SetATParam (UINT_32 offset, UINT_32 value)
{
	MTK_WIFI_TEST_STRUC m_AT_cmd;

	DEBUGFUNC("CMT5905::SetATParam");
	INITLOG((_T("\n")));

	m_AT_cmd.bRead = FALSE;
...
**__________________________________________________________________________*/
INT_32
CMT5905::GetATParam (UINT_32 offset, UINT_32 * value)
{
	MTK_WIFI_TEST_STRUC m_AT_cmd;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT5905::GetATParam");
	INITLOG((_T("\n")));
...
**__________________________________________________________________________*/
INT_32
CMT5905::setChipType (UINT_32 u4InChipType) 
{
    return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT5905::setEEPRomFromFile(TCHAR* fileName)
{
#if 0
    INT_32 iSize, status;
	INT_32 i;
...
**__________________________________________________________________________*/
INT_32
CMT5905::setXtalFreqTrimToEEProm (
	INT_32 i4FreqTrim
	)
{
	return ERROR_RFTEST_SUCCESS;
...
**__________________________________________________________________________*/
INT_32
CMT5905::setAnritsu8860bTestSupportEn (
    INT_32    i4Enable
	)
{
    return ERROR_RFTEST_SUCCESS;
