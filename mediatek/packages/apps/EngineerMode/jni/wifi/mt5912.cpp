...
/*
** $Id: mt5912.cpp,v 1.4 2008/10/28 13:45:43 MTK01725 Exp $
*/
...
#define SCR_BB_GATING_DISABLE           BIT(5)
...
#define GPIOCR_GPIO_0_32K_OUTPUT_ENABLE BIT(5)
...
#define LCR_LED_RX_FILTER_DISABLE       0
#define LCR_LED_RX_FILTER_ENABLE        BIT(21)
...
#define WBCR2_REMAIN_TIME                  BITS(24,31)
#define WBCR2_SINGLE_ANT_ENABLE            BIT(23)
#define WBCR2_BT_RATIO                     BITS(19,22)
#define WBCR2_BT_ACT_POL                   BIT(18)
#define WBCR2_WLAN_ACT_POL                 BIT(17)
#define WBCR2_WLAN_ACT_LOW                 BIT(17)
#define WBCR2_WLAN_ACT_HIGH                0
#define WBCR2_BT_PRI_POL                   BIT(16)
#define WBCR2_BT_PRI_ACT_LOW               BIT(16)
#define WBCR2_BT_PRI_ACT_HIGH              0
#define WBCR2_WLAN_ASSERT_CTRL_ENABLE      BIT(12)
#define WBCR2_WLAN_ASSERT_TX_ENABLE        BIT(11)
#define WBCR2_TX_DELAY                     BITS(8, 10)
#define WBCR2_RF_SHNT_WHILE_HONOR_ENABLE   0
#define WBCR2_RF_SHNT_WHILE_HONOR_DISABLE  BIT(7)
#define WBCR2_PROTOCOL_MASK                BIT(6)
#define WBCR2_PROTOCOL_THREE_WIRE          0
#define WBCR2_PROTOCOL_TWO_WIRE            BIT(6)
#define WBCR2_ACK_MODE                     BIT(5)
#define WBCR2_SLEEP_ANT_SWITCH_EN          BIT(4)
#define WBCR2_ASSERT_BEFORE_BEACON_EN      BIT(3)
#define WBCR2_ASSERT_THROUGH_ACK_EN        BIT(2)
#define WBCR2_WLAN_ASSERT_RX_ENABLE        BIT(1)
#define WBCR2_COEXIST_EN                   BIT(0)
...
/* Start/end address for each table in EEPROM */
/* CCK TX Power Gain Table for 2.4G band */
#define EEPROM_2G_CCK_TXPWR_GAIN_START          0x16
#define EEPROM_2G_CCK_TXPWR_GAIN_END            0x1C
...
/* CCK Tx Tower Mark Table for 2.4G band */
#define EEPROM_2G_CCK_TX_PWR_MARK_START         0x24
#define EEPROM_2G_CCK_TX_PWR_MARK_END           0x26

/* OFDM Tx Tower Mark Table for 2.4G band */
#define EEPROM_2G_OFDM_TX_PWR_MARK_START        0x27
#define EEPROM_2G_OFDM_TX_PWR_MARK_END          0x29

/* OFDM TX Power Gain Table for 5G band */
#define EEPROM_5G_OFDM_TXPWR_GAIN_START         0x2A
#define EEPROM_5G_OFDM_TXPWR_GAIN_END           0x3A

/* EEPROM signature field (word offset: 0x00) */
#define EEPROM_SIGNATURE_MT5912                 0x5912
...
INT_32
CMT5912::readMCR32 (UINT_32 offset, UINT_32 * value)
{
	IPC_MCR_RW_STRUC m_sMACREG_RW;
	UINT_32 BytesRead;

	DEBUGFUNC("CMT5912::readMCR32");
	INITLOG((_T("\n")));
...
**__________________________________________________________________________*/
INT_32
CMT5912::writeMCR32 (UINT_32 offset, UINT_32 value)
{
	IPC_MCR_RW_STRUC m_sMACREG_RW;

	DEBUGFUNC("CMT5912::writeMCR32");
	INITLOG((_T("\n")));
...
**__________________________________________________________________________*/
INT_32
CMT5912::readBBCR8 (UINT_32 offset, UINT_32* value)
{
...
**__________________________________________________________________________*/
INT_32
CMT5912::writeBBCR8 (UINT_32 offset, UINT_32 value)
{
	IPC_BBCR_RW_STRUC m_sMMI_RW;
...
**__________________________________________________________________________*/
INT_32
CMT5912::readEEPRom16 (UINT_32 offset, UINT_32 * value)
{
...
**__________________________________________________________________________*/
INT_32
CMT5912::writeEEPRom16 (UINT_32 offset, UINT_32 value)
{
	IPC_EEPROM_RW_STRUC m_sEEPRom_RW;
...
CMT5912::setTestMode(void)
{
    ...
    readMCR32(MCR_WBCR2,    &ioRegSave[2]);
...
CMT5912::setNormalMode(void)
{
    ...
    writeMCR32(MCR_WBCR2,   ioRegSave[2]);
...
**__________________________________________________________________________*/
INT_32
CMT5912::setLocalFrequecy(INT_32 txPower, INT_32 txAntenna)
{
	UINT_32 status;
...
**__________________________________________________________________________*/
INT_32
CMT5912::setAlcSlopeRatioToEeprom (
...
**__________________________________________________________________________*/
INT_32
CMT5912::setTXMaxPowerToEEProm(INT_32 channelFreg, INT_32 bCck, INT_32 nTxPwr)
{
...
**__________________________________________________________________________*/
INT_32
CMT5912::setTXMaxPowerToEEPromEx(
	INT_32 channelFreq,
	INT_32 rate,
	INT_32 gainControl,
	INT_32 outputPower,
...
**__________________________________________________________________________*/
INT_32
CMT5912::readTxPowerFromEEPromEx(
    INT_32 channelFreq,
    INT_32 rate,
    INT_32 *nTxPwr,
    INT_32 *outputPower,
...
INT_32
CMT5912::setEEPromCKSUpdated (void)
{
	UINT_8 checkSum;
...
INT_32
CMT5912::getDACOffset (
	UINT_16* dacOffset
	)
{
	UINT_8 dposi, dposq;
	UINT_32 m_2dadci1, m_2dadcq1;
	UINT_32 mcrValue, oldPPMCR;

	/* Disable BB Gating before access */
	readMCR32(MCR_SCR, &mcrValue);
	writeMCR32(MCR_SCR, mcrValue | SCR_BB_GATING_DISABLE);

	readMCR32(MCR_PPMCR, &oldPPMCR);
	writeMCR32(MCR_PPMCR, oldPPMCR | PPMCR_GPIO_RF_TX);
	...
	writeMCR32(MCR_SCR, mcrValue);
	writeMCR32(MCR_PPMCR, oldPPMCR);
	...
	INT_32 outputLevel)
{
	...
	{
		case 0: /* GPIO0 */
			//set GPIO0 to function GPIO0, not BT_ACT
			u4Value = 0;

			result = writeMCR32(MCR_WBCR2, u4Value);
			if(result)
				break;
		...
		case 5: /* WLAN_ACT */
		    ...
		    u4Value = WBCR2_COEXIST_EN | WBCR2_WLAN_ASSERT_RX_ENABLE |
		        WBCR2_PROTOCOL_TWO_WIRE | WBCR2_RF_SHNT_WHILE_HONOR_ENABLE |
		        WBCR2_WLAN_ASSERT_TX_ENABLE;
		    if (outputLevel) {
		        u4Value |= WBCR2_WLAN_ACT_LOW;
            }
	...
	INT_32* inputLevel)
{
	...
	switch(pinIndex){
		...
		case 2: /* EXT_INT */
			...
			result = readMCR32(MCR_SCR, &u4Value);
			if(result)
				break;

			if(u4Value & SCR_EXTERNAL_INT_STATUS)
				*inputLevel = 1;
			else
				*inputLevel = 0;
	...
	INT_32	inputLevel)
{
	...
	switch(pinIndex)
	{
		case 0: /* BT_PRIORITY */
			...
			if(inputLevel == 0)
				u4Value |= WBCR2_BT_PRI_ACT_LOW;
			else
				u4Value |= WBCR2_BT_PRI_ACT_HIGH;
...
CMT5912::restoreIOPin(void)
{
	...
	result = writeMCR32(MCR_WBCR2, ioRegSave[2]);
	if(result)
		return result;
...
**__________________________________________________________________________*/
INT_32
CMT5912::findMaxPowerByteOffset(INT_32 nChannel, INT_32 bCck, INT_32 b24Gs)
{
    INT_32 offset;
    INT_32 i;
...
CMT5912::setPPMCRAndSCR(void)
{
    ...
    /* Disable BB Gating before access and PAU */
    writeMCR32(MCR_SCR,
	    (dscrTmp & (~SCR_PAU_EN)) | SCR_BB_GATING_DISABLE);
...
INT_32
CMT5912::setBBTxPower(INT_32 txPower)
{
    /* OFDM TX Power */
...
INT_32
CMT5912::setTxAnt(INT_32 antenna)
{
    UINT_32 nCr8;
...
UINT_8
CMT5912::getTxRate(INT_32 nTxRate, INT_32 nPreamble)
{
	UCHAR ucTxRate = 0;
	switch (nTxRate) {
	    default:
...
UINT_8
CMT5912::nicCalculateChecksumByte(void * startingAddr_p,UINT_32 length)
{
    UINT_32 i;
    UINT_8 * cp;
    UINT_8 result;
...
**__________________________________________________________________________*/
INT_32
CMT5912::getEEPRomVersion_(void)
{
    UINT_32 value;
    UINT_32 eepValue;
...
INT_32
CMT5912::GetATParam (UINT_32 offset, UINT_32 * value)
{
	DEBUGFUNC("CMT5912::GetATParam");
    INITLOG((_T("\n")));
	TCHAR buf[128];
	_stprintf(buf, _T("get: offset: %d \n"), offset);
	INITLOG((buf));
...
INT_32
CMT5912::SetATParam (UINT_32 offset, UINT_32 value)
{
	DEBUGFUNC("CMT5912::SetATParam");
    INITLOG((_T("\n")));
	TCHAR buf[128];
	_stprintf(buf, _T("set: offset: %d, value: %d \n"), offset, value);
	INITLOG((buf));
...
NIC_BBCR_CONFIG_ENTRY dacInitTable_12[] = {
    {NULL, BBCR_CR82, 0xA1},
    {NULL, BBCR_CR88, 0x80},
    {NULL, BBCR_CR89, 0x80},
    {NULL, BBCR_CR8, 0x80},
...
NIC_BBCR_CONFIG_ENTRY dacStep1Table_12[] = {
    {NULL, BBCR_CR93, 0xAA},
    {NULL, BBCR_CR94, 0x10},
    {NULL, BBCR_CR89, 0x00}
};

NIC_BBCR_CONFIG_ENTRY dacStep2Table_12[] = {
    {NULL, BBCR_CR93, 0xA9},
    {NULL, BBCR_CR94, 0x10},
    {NULL, BBCR_CR89, 0x00}
};
...
void
CMT5912::DACInit(void)
{
    UINT_32 i, value;

    for(i =0 ; i < sizeof(dacInitTable_12)/sizeof(NIC_BBCR_CONFIG_ENTRY); i++){
        writeBBCR8(dacInitTable_12[i].offset, dacInitTable_12[i].value);
    }
...
void
CMT5912::DACSetep1(UINT_8* dposi, UINT_8* dposq)
{
    UINT_32 i, value;

    for(i =0 ; i < sizeof(dacStep1Table_12)/sizeof(NIC_BBCR_CONFIG_ENTRY); i++){
        writeBBCR8(dacStep1Table_12[i].offset, dacStep1Table_12[i].value);
    }
...
void
CMT5912::DACSetep2(UINT_8* dnegi, UINT_8* dnegq)
{
    UINT_32 i, value;

    for(i =0 ; i < sizeof(dacStep2Table_12)/sizeof(NIC_BBCR_CONFIG_ENTRY); i++) {
        writeBBCR8(dacStep2Table_12[i].offset, dacStep2Table_12[i].value);
    }
    ...
    UINT_8* bestQ)
{
    ...
    for( i = 0 ; i < 10 ; i ++) {
        ...
        diff_i[0] += diff_12(targetIx2, 2 *(UINT)dadci);
        diff_q[0] += diff_12(targetQx2, 2 *(UINT)dadcq);

        DACSetep4( (UINT_8)valueID + mapI[1], (UINT_8)valueQD + mapQ[1], &dadci, &dadcq);
        diff_i[1] += diff_12(targetIx2, 2 *(UINT)dadci);
        diff_q[1] += diff_12(targetQx2, 2 *(UINT)dadcq);

        DACSetep4( (UINT_8)((UINT)valueID + mapI[2]), (UINT_8)valueQD + mapQ[2], &dadci, &dadcq);
        diff_i[2] += diff_12(targetIx2, 2 *(UINT)dadci);
        diff_q[2] += diff_12(targetQx2, 2 *(UINT)dadcq);

        DACSetep4( (UINT_8)((UINT)valueID + mapI[3]), (UINT_8)((UINT)valueQD + mapQ[3]), &dadci, &dadcq);
        diff_i[3] += diff_12(targetIx2, 2 *(UINT)dadci);
        diff_q[3] += diff_12(targetQx2, 2 *(UINT)dadcq);

        DACSetep4( (UINT_8)valueID + mapI[4], (UINT_8)((UINT)valueQD + mapQ[4]), &dadci, &dadcq);
        diff_i[4] += diff_12(targetIx2, 2 *(UINT)dadci);
        diff_q[4] += diff_12(targetQx2, 2 *(UINT)dadcq);
    }
...
**__________________________________________________________________________*/
INT_32
CMT5912::setChipType (UINT_32 u4InChipType) 
{
    return ERROR_RFTEST_SUCCESS;
}
...
**__________________________________________________________________________*/
INT_32
CMT5912::setEEPRomFromFile(TCHAR* fileName)
{
	INT_32 iSize, status;
	INT_32 i;
	UINT_16	dacOffset;
...
**__________________________________________________________________________*/
INT_32
CMT5912::setXtalFreqTrimToEEProm (
	INT_32 i4FreqTrim
	)
{
	return ERROR_RFTEST_SUCCESS;
...
**__________________________________________________________________________*/
INT_32
CMT5912::setAnritsu8860bTestSupportEn (
    INT_32    i4Enable
	)
{
    return ERROR_RFTEST_SUCCESS;
