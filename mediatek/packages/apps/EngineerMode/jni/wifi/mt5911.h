...
/*
** $Id: mt5911.h,v 1.3 2008/06/12 02:34:19 MTK01385 Exp $
*/
...
**
** Revision 1.2  2008/01/03 07:54:15  MTK01385
...
**
** Revision 1.3  2007/10/17 08:49:51  MTK01267
...
class DllExport CMT5911 : public CAdapter
{
protected:
    ~CMT5911(void){}

public:
    CMT5911(const wstring &Name, const wstring &Desc, COID * oid, CSite *SiteName):CAdapter(Name, Desc, oid, SiteName){}
	UINT_32 ChipID() { return 0x5911;}
