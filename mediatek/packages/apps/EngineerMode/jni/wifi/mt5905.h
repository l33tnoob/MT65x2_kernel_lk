...
/*
** $Id: mt5905.h,v 1.3 2008/06/12 02:34:19 MTK01385 Exp $
*/
...
**
** Revision 1.5  2008/02/23 16:30:18  MTK01385
...
class DllExport CMT5905 : public CAdapter
{
public:
    CMT5905(const wstring &Name, const wstring &Desc, COID * oid, CSite *SiteName):CAdapter(Name, Desc, oid, SiteName){}
    ~CMT5905(void){}
	UINT_32 ChipID() { return 0x5905;}
