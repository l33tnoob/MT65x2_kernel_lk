...
/*
** $Id: mt5921.h,v 1.5 2008/11/11 03:12:13 MTK01725 Exp $
*/
...
#endif 
class CMT5921 : public CAdapter{
protected:
    ~CMT5921(void){}

public:
    CMT5921(const char *Name, const char *Desc, COID* oid, const char* wrapperName):CAdapter(Name, Desc, oid, wrapperName), fgAnritsuSupportEn(false)
       , u4OriRoamingEn(0) {isEepromUsed = false;}

	UINT_32 ChipID() { return 0x5921;}
    ...
    INT_32 getEEPRomSize(INT_32 * eepromSz);
   	INT_32 getSpecEEPRomSize(INT_32 * eepromSz);
