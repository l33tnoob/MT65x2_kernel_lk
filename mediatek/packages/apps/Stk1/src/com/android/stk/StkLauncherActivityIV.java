...
public class StkLauncherActivityIV extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.GEMINI_SIM_4) != StkAppService.STK_AVAIL_AVAILABLE)
        {
            ...
            if (FeatureOption.MTK_GEMINI_SUPPORT == true) {
                simState = TelephonyManagerEx.getDefault().getSimState(PhoneConstants.GEMINI_SIM_4);
            } else {
    ...
    boolean isOnFlightMode() {
        ...
        try {
            ...
            CatLog.d("Stk-LAIV", "fail to get airlane mode");
            mode = 0;
        }
        
        CatLog.d("Stk-LAIV", "airlane mode is " + mode);
        return (mode != 0);
    }
