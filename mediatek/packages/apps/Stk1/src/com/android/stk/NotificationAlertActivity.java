...
//        }
        ...
        int sim_id = intent.getIntExtra(StkAppService.CMD_SIM_ID, PhoneConstants.GEMINI_SIM_1);
        CatLog.d(LOGTAG, "NotificationAlertActivity, sim id: " + sim_id);
        mNotificationMessage = StkApp.mIdleMessage[sim_id];
