...
public class PropertyNode {
    ...
    public boolean equals(Object obj) {
        ...
        if (propValue_bytes != null && Arrays.equals(propValue_bytes, node.propValue_bytes)) {
            ...
            // to
            // check it.
            return (propValue_vector.equals(node.propValue_vector) || propValue_vector.size() == 1 || node.propValue_vector
                    .size() == 1);
        }
    }
    ...
    public String encode() {
        ...
        if (paramMap.size() > 0 || paramMap_TYPE.size() > 0) {
            ...
            for (Entry<String, Object> entry : values.valueSet()) {
                ...
                builder.append("=");
                builder.append(entry.getValue().toString().replaceAll("\\\\", "\\\\\\\\")
                        .replaceAll(",", "\\\\,"));
                if (i < size - 1) {
                    builder.append(",");
                }
    ...
    public static PropertyNode decode(String encodedString) {
        ...
        for (String elem : elems) {
            ...
            if (name.equals("propName")) {
                ...
                for (String value : values) {
                    ...
                    // \\ -> \
                    // In String#replaceAll(), "\\\\" means a single backslash.
                    String mapValue = tmp[1].replaceAll("\\\\,", ",")
                            .replaceAll("\\\\\\\\", "\\\\");
        ...
        if (encoding != null
                && (encoding.equalsIgnoreCase("BASE64") || encoding.equalsIgnoreCase("B"))) {
            propertyNode.propValue_bytes = Base64.decodeBase64(propertyNode.propValue_vector.get(0)
                    .getBytes());
        }
