...
/**
 * VBuilder for VCard. VCard may contain big photo images encoded by BASE64, If
 * we store all VNode entries in memory like VDataBuilder.java, OutOfMemoryError
 * may be thrown. Thus, this class push each VCard entry into ContentResolver
 * immediately.
 */
public class VCardDataBuilder implements VBuilder {
     ...
     * @hide
     */
    public VCardDataBuilder(String sourceCharset, String targetCharset,
    ...
    public void startRecord(String type) {
        ...
        if (mCurrentContactStruct != null) {
            // This means startRecord() is called inside startRecord() -
            // endRecord() block.
            // TODO: should throw some Exception
            NmsLog.trace(HissageTag.vcard, "Nested VCard code is not supported now.");
        }
        if (!type.equalsIgnoreCase("VCARD")) {
            // TODO: add test case for this
            NmsLog.trace(HissageTag.vcard, "This is not VCARD!");
        }
    ...
    public void propertyParamType(String type) {
        if (mParamType != null) {
            NmsLog.trace(HissageTag.vcard, "propertyParamType() is called more than once "
        ...
        if (encoding != null) {
            if (encoding.equals("BASE64") || encoding.equals("B")) {
                ...
                try {
                    ...
                    NmsLog.trace(HissageTag.vcard, "Failed to encode: charset=" + mSourceCharset
                            + NmsLog.nmsGetStactTrace(e1));
                ...
                try {
                    ...
                    NmsLog.trace(HissageTag.vcard, "Failed to decode quoted-printable: " + e);
                    return "";
                }
                ...
                try {
                    ...
                    NmsLog.trace(HissageTag.vcard, "Failed to encode: charset=" + targetCharset);
    ...
    public void propertyValues(List<String> values) {
        ...
        String charset = ((charsetCollection != null) ? charsetCollection.iterator().next() : null);
        ...
        String encoding = ((encodingCollection != null) ? encodingCollection.iterator().next()
                : null);
        ...
        for (String value : values) {
            mCurrentProperty.addToPropertyValueList(handleOneValue(value, targetCharset, encoding));
        }
    }

    public void showPerformanceInfo() {
        NmsLog.trace(HissageTag.vcard, "time for insert ContactStruct to database: "
