...
public class VCardConfig {
     ...
     * appropriate fields for that data.
     * 
     * For example, Android accepts nickname information while vCard 2.1 does
     * not. When this flag is on, vCard composer emits alternative "X-" property
     * (like "X-NICKNAME") instead of just dropping it.
     * 
     * vCard parser code automatically parses the field emitted even when this
     * flag is off.
     * 
     * Note that this flag does not assure all the information must be hold in
     * the emitted vCard.
     */
     ...
     * vCard specification does not have appropriate field(s) for that data.
     * 
     * One example is
     ...
     * 
     * Note for developers: only "X-" properties should be added with this flag.
     * vCard 2.1/3.0 allows any kind of "X-" properties but does not allow
     * non-"X-" properties (except IANA tokens in vCard 3.0). Some external
     * parsers may get confused with non-valid, non-"X-" properties.
     */
     ...
     * "Prefix Given Middle Family Suffix", while in Japan, it should be
     ...
     * remain both in parsing and composing.
     * 
