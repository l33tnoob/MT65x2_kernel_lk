...
public class GroupManagerExt extends GroupManager {
    private static final String TAG = "imsp/GroupManagerExt";

    public GroupManagerExt(Context context) {
        super(context);
    }

    public int[] getGroupIdList() {
        return NmsIpMessageApi.getInstance(mContext).nmsGetGroupIdList();
    }

    public int getGroupIpMessageCount(long threadId) {
        return NmsIpMessageApi.getInstance(mContext).nmsGetIpMsgCountOfThread(threadId);
    }
}
