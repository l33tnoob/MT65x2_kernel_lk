...
public class ExtensionUtils {
        ...
        IProjectStringExt ext;
        PluginManager<IProjectStringExt> pm = PluginManager.<IProjectStringExt>create(context, IProjectStringExt.class.getName());
            if(pm != null && pm.getPluginCount() != 0){
                Plugin<IProjectStringExt> plugin = pm.getPlugin(0);
                if (plugin != null) {
                    try {
                        ext = plugin.createObject();
