...
public class PrxrPsmConn extends PsmConnection {
	 ...
	 * @param bdaddr
	 */
	protected PrxrPsmConn(){

		super( PrxrConstants.PRXR_STATE_NEW );
	}

	protected void setPeerDevice( BluetoothDevice peerDevice ){
