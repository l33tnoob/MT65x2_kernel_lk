...
public class FolderListRequest{
		private int 		mMasId;
		private String 		mAddr;	//the field may be useful when support multi device in one instance
		private int 		mSize;		// optional
		private int 		mOffset;		//optional

		private boolean isOccupied = false; // flag to indicate whether the object is available
		
		public FolderListRequest(int masId) {
			mMasId = masId;
		}
