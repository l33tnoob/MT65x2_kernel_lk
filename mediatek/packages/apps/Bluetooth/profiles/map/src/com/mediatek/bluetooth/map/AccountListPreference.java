...
{
	private static String TAG = "AccountListPreference";

	private boolean pendingAccountChanged = false; 
		...
		public void onResume() {
			...
			if (pendingAccountChanged && dialog != null) {
				pendingAccountChanged = false;
				dialog.dismiss();
				super.onClick();
			}
			}
		public synchronized void onAccountChanged() {
			pendingAccountChanged = true;
		}
	}
