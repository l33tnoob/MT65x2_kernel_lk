...
/**
 * The service to delete old data about upgrade package path.
 * @author mtk80357
 *
 */
public class SysOperService extends Service {

    private static final String TAG = "GoogleOta/SysOper";
    ...
    class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Xlog.i(TAG, "SysOperService:handleMessage, msg.what=" + msg.what);
            switch (msg.what) {
            case MSG_DELETE_COMMANDFILE:
                Bundle data = msg.getData();
                if (data != null) {
                    String commandfile = data.getString(CMD_FILE_KEY);
                    Xlog.i(TAG, "handleMessage, commandfile=" + commandfile);
    ...
    private void deleteCommandFile(String path) {
        ...
        if (file.exists()) {
            Xlog.i(TAG, "deleteCommandFile, command exist, delete it");
            file.delete();
        }
