...
//LINE <> <DATE20140730> <s4700 add sensor:shunyu ov5648> limi.zhang
...
#endif
//END<><20140111><add sensor driver>wangyanhui
//BEGIN <> <20140729> <add the hi258 sunwin camera module> panzaoyan
#if defined(HI545_MIPI_RAW)
    {HI545MIPI_SENSOR_ID, SENSOR_DRVNAME_HI545_RAW, HI545_MIPI_RAW_SensorInit}, 
#endif
//END <> <20140729> <add the hi258 sunwin camera module> panzaoyan
