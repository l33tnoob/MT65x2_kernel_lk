...
#define LCM_DBG(fmt, arg...) \
	LCM_PRINT("[LCM_OTM8018B_FWVGA_DSI_BOE] %s (line:%d) :" fmt "\r\n", __func__, __LINE__, ## arg)
...
static struct LCM_setting_table lcm_initialization_setting[] = {
  ...
  {0X00,	1,	{0XA0}},
        {0XC1,	1,	{0xEA}}, 
  {0X00,	1,	{0X00}},
        {0XE1,	16,	{0x00,0x08,0x10,0x11,
            	       0x0A,0x1E,0x0D,0x0E,
            	       0x00,0x05,0x02,0x07,
            	       0x0F,0x1F,0x1B,0x00}},  
   {0x00,	1,	{0x00}},	
	      {0xE2,	16,	{	0x00,0x08,0x10,0x12,
	          	        0x0A,0x1E,0x0D,0x0D,
	          	        0x01,0x05,0x03,0x07,
	          	        0x0F,0x20,0x1C,0x00}}, 
	{0x00,	1,	{0x80}},	
...
LCM_DRIVER otm8018b_fwvga_dsi_vdo_boe_lcm_drv = 
{
