...
static void lcm_set_gpio_output(unsigned int GPIO, unsigned int output)
{
    ...
    {
    #ifdef BUILD_LK
	 printf("[LK/LCM] GPIO_LCD_PWR =   \n",GPIO_LCD_PWR);
        printf("[LK/LCM] GPIO_LCD_PWR_EN =   \n",GPIO_LCD_PWR_EN);
        printf("[LK/LCM] GPIO_LCD_PWR2_EN =   \n",GPIO_LCD_PWR2_EN);
        printf("[LK/LCM] GPIO_LCD_RST_EN =   \n",GPIO_LCD_RST_EN);
        printf("[LK/LCM] GPIO_LCD_STB_EN =   \n",GPIO_LCD_STB_EN);
        printf("[LK/LCM] GPIO_SHIFT_EN =   \n",GPIO_SHIFT_EN);
        printf("[LK/LCM] GPIO_LCD_BL_EN =   \n",GPIO_LCD_BL_EN);
        printf("[LK/LCM] GPIO_LCD_BRIDGE_EN =   \n",GPIO_LCD_BRIDGE_EN);
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->physical_width = 153;
    params->physical_height = 90;
...
#ifdef CUSTOM_3G_SUPPORT
    params->dpi.mipi_pll_clk_ref  = 496915327;
#else
...
static void lcm_resume(void)
{
    ...
    lcm_set_gpio_output(GPIO_LCD_BL_EN, 1);
		...
		// do nothing in uboot
#else
	printk("[LCM] MT8193 LVDS lcm_resume() enter\n");
...
LCM_DRIVER lvds_wsvga_mt8193_lcm_drv = 
{
    .name		= "lvds_wsvga_mt8193",
