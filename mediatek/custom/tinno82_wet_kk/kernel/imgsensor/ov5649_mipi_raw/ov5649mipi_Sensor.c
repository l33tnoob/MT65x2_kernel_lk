...
extern bool otp_update_wb_ov5649(unsigned short golden_rg, unsigned short golden_bg);
...
//    if (sensor_id != OV5649MIPI_SENSOR_ID){
    ...
    otp_update_wb_ov5649(0x177,0x15d);//darling
...
//BEGIN <> <20130828> <check the truly MID> panzaoyan
    ...
    if( 0==check_darlingMID(0) ) //it is not truly module
    	{	
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    SENSORDB("Exit!");
    OV5649MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR); //added by panzaoyan, 20130816
...
OV5649MIPI_Set_Mirror_Flip(IMAGE_HV_MIRROR); //LINE <SEFOS-305: the image's orientation is reversed when into zsd mode> <20130917> <> panzaoyan
